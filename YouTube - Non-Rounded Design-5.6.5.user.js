...
[page-subtype="channels"] .yt-content-metadata-view-model-wiz__metadata-text, [page-subtype="playlist"] .yt-content-metadata-view-model-wiz__metadata-text, [page-subtype="channels"] .truncated-text-wiz, [page-subtype="playlist"] .truncated-text-wiz, [page-subtype="channels"] .truncated-text-wiz__absolute-button, [page-subtype="playlist"] .truncated-text-wiz__absolute-button { font-size: 1.4rem !important }
